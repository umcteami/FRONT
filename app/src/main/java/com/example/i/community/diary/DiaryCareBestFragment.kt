...
class DiaryCareBestFragment : Fragment(), View.OnClickListener,PplTalkroomInterface {
    ...
    override fun onCreateView(
        ...
        PplTalkroomService(this).tryGetPplTalkroom("diary",1,0,1)
    ...
    override fun onGetPplTalkroomFailure(message: String) {
        Log.d("error","간호일기 인기글 오류: $message")
    }
}