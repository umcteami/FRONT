...
class CommunityTalkActivity : AppCompatActivity() {
    private lateinit var viewBinding: ActivityCommunityTalkBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBinding = ActivityCommunityTalkBinding.inflate(layoutInflater)
        setContentView(viewBinding.root)

        val viewPager = viewBinding.viewpager
        val tabLayout = viewBinding.tabLayout

        viewPager.adapter = CommunityTalkViewPagerAdapter(supportFragmentManager, lifecycle)
